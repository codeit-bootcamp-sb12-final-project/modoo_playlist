...
public class GlobalExceptionHandler {
    ...
    private HttpStatus parseHttpStatus(BaseException e) {
        ...
        return switch (code) {
            case USER_NOT_FOUND, POST_NOT_FOUND, COMMENT_NOT_FOUND, FOLLOW_NOT_FOUND, REVIEW_NOT_FOUND, CONVERSATION_NOT_FOUND,
                 PLAYLIST_NOT_FOUND, PLAYLIST_CONTENT_NOT_FOUND, PLAYLIST_SUBSCRIPTION_NOT_FOUND, MESSAGE_NOT_FOUND -> HttpStatus.NOT_FOUND;
            case USER_ALREADY_EXISTS, FOLLOW_ALREADY_EXISTS, REVIEW_ALREADY_EXISTS,
                 PLAYLIST_CONTENT_ALREADY_EXISTS, PLAYLIST_SUBSCRIPTION_ALREADY_EXISTS -> HttpStatus.CONFLICT;
            case INVALID_CREDENTIALS -> HttpStatus.UNAUTHORIZED;
            case REVIEW_ACCESS_DENIED, PLAYLIST_ACCESS_DENIED, CONVERSATION_ACCESS_DENIED, FOLLOW_ACCESS_DENIED -> HttpStatus.FORBIDDEN;
            case INVALID_REQUEST, SELF_FOLLOW_NOT_ALLOWED, SELF_CONVERSATION_NOT_ALLOWED, REQUIRED_WITH_USER -> HttpStatus.BAD_REQUEST;
